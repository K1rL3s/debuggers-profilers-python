...
print(timeit.timeit("list(map(str, r))", setup="r = range(100)", number=n))
# 7.257156100000429

print(timeit.timeit("[str(x) for x in r]", setup="r = range(100)", number=n))
# 6.102027400000225

print(timeit.timeit("list(map(lambda x: x * 2, r))", setup="r = range(100)", number=n))
# 4.217808600002172

print(timeit.timeit("[x * 2 for x in r]", setup="r = range(100)", number=n))
# 1.9810508999980811
